...
import { Upload, X, Plus, Leaf, ChevronLeft, MessageCircle } from "lucide-react"
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Button variant="outline" onClick={() => setShowChatBot(true)} className="flex items-center gap-2">
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 flex items-center">
                <span className="text-2xl font-bold text-green-600 mr-2">{estimatedPoints}</span>
          ...
          <Button
            type="submit"
            className="w-full h-12 text-lg font-semibold bg-gradient-to-r from-green-500 to-orange-500 hover:from-green-600 hover:to-orange-600"
            disabled={
              !formData.title ||
              !formData.category ||
              !formData.condition ||
          ...
          <p className="text-center text-sm text-gray-600">Your item will be reviewed by our team before going live</p>
        </form>
      </div>
